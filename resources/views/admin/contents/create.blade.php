...
@section('title')
    <title>{{ isset($content) ? 'İçerik Düzenle' :  'İçerik Ekle' }}</title>
@endsection
                ...
                <form action="{{ isset($content) ? route('contents.update', $content->slug) : route('contents.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div id="list">
                        @if(isset($content))
                            <div class="form-group">
                                <img src="{{ asset('storage/'.$content->cover) }}" alt="" style="width: 6rem; height: 6rem;">
                            </div>
                        @endif
                    ...
                    <div class="form-group">
                        <button class="btn btn-success">
                            {{ isset($content) ? 'Düzenle' : 'İçerik Ekle' }}
                        </button>
                    </div>
                </form>
            </div>
