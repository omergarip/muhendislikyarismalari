    ...
    <main>
            ...
            <div class="js--wp-1">
                @if($competitions->count() > 0)
                                ...
                                <figure class="competitions">
                                    <div class="competitions__hero">
                                        <a href="{{ route('competitions.show', $competition->slug) }}">
                                            <img src="{{ asset('/'.$competition->image) }}" alt="{{ $competition->title }}" class="competitions__img">
                                        </a>
                                    </div>
                    ...
                    <div class="u-center-text u-margin-top-big">
                        <a class="bttn bttn--green" href="{{ route('competitions.index') }}">DAHA FAZLA GÖR</a>
                    </div>
        ...
        <section class="section-contents">
                            ...
                            <div class="carousel-inner w-100" role="listbox">
                                <div class="carousel-item active">
                                    <div class="col-lg-4 col-md-6">
                                        <a href="{{ route('contents.show', [$first_content[0]->series_link, $first_content[0]->slug]) }}">
            ...
            <div class="u-center-text u-margin-top-huge">
                <a href="{{ route('contents.index') }}" class="btn-text">İçeriklere Göz At &rarr;</a>
            </div>
        </section>
